...
# Executa auto_migrate.py se for ambiente de desenvolvimento e AUTO_MIGRATE estiver ativado
if env == "development" and os.getenv("AUTO_MIGRATE", "false").lower() == "true":
    try:
        ...
        print("❌ Arquivo auto_migrate.py não encontrado. Verifique se ele está na raiz do projeto.")
